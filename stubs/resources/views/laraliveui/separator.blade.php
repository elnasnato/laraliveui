...
$classes = Laraliveui::classes('border-0 [print-color-adjust:exact]')
    ->add(match ($variant) {
...
<?php if ($text): ?>
    <div data-orientation="{{ $orientation }}" class="flex items-center w-full" role="none" data-laraliveui-separator>
...
<?php else: ?>
    <div data-orientation="{{ $orientation }}" role="none" {{ $attributes->class($classes, 'shrink-0') }} data-laraliveui-separator></div>
<?php endif; ?>
