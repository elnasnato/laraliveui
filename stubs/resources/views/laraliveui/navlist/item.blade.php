...
$iconClasses = Laraliveui::classes($square ? 'size-5!' : 'size-4!');
...
<laraliveui:button-or-link :attributes="$attributes->class($classes)" data-laraliveui-navlist-item>
    <?php if ($icon): ?>
        <div class="relative">
    ...
    <?php if ($iconDot && ! $icon && $iconTrailing): ?>
        <div class="relative">
            <?php if (is_string($iconTrailing) && $iconTrailing !== ''): ?>
                <laraliveui:icon :icon="$iconTrailing" :variant="$iconVariant" class="size-4!" />
            <?php else: ?>
                {{ $iconTrailing }}
            <?php endif; ?>
    ...
    <?php if (isset($badge) && $badge !== ''): ?>
        ...
        <laraliveui:navlist.badge :attributes="$badgeAttributes">{{ $badge }}</laraliveui:navlist.badge>
    <?php endif; ?>
