...
$classes = Laraliveui::classes()
    ...
    ->add('in-data-laraliveui-sidebar-collapsed-desktop:opacity-0')
    ->add('in-data-laraliveui-sidebar-collapsed-desktop:absolute')
    ->add('in-data-laraliveui-sidebar-collapsed-desktop:in-data-laraliveui-sidebar-active:opacity-100')
    ->add($inset ? Laraliveui::applyInset($inset, top: '-mt-2.5', right: '-me-2.5', bottom: '-mb-2.5', left: '-ms-2.5') : '')
    ;

$buttonClasses = Laraliveui::classes()
    ...
    ->add('in-data-laraliveui-sidebar-collapsed-desktop:cursor-e-resize rtl:in-data-laraliveui-sidebar-collapsed-desktop:cursor-w-resize')
    ->add('[&[collapsible="mobile"]]:in-data-laraliveui-sidebar-on-desktop:hidden')
    ->add('rtl:rotate-180')
    ;
@endphp

<ui-sidebar-toggle {{ $attributes->class($classes) }} data-laraliveui-sidebar-collapse>
