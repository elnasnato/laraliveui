...
$iconClasses = Laraliveui::classes('text-zinc-500 dark:text-zinc-400 [ui-radio[data-checked]_&]:text-zinc-800 dark:[ui-radio[data-checked]_&]:text-white')
...
<ui-radio {{ $attributes->class($classes) }} data-laraliveui-control data-laraliveui-radio-segmented tabindex="-1">
    ...
    <?php if (is_string($iconTrailing) && $iconTrailing !== ''): ?>
        <laraliveui:icon :icon="$iconTrailing" variant="micro" />
