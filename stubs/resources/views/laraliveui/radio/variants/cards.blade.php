...
$classes = Laraliveui::classes()
    ...
    ->add(match ($accent) {
        true => [
            '[&:hover_[data-laraliveui-radio-indicator]]:border-[var(--haze-border)] dark:[&:hover_[data-laraliveui-radio-indicator]]:border-white/10',
...
<ui-radio {{ $attributes->class($classes) }} data-laraliveui-control data-laraliveui-radio-cards tabindex="-1" data-laraliveui-field>
    <?php if ($label): ?>
