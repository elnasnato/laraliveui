...
<div {{ $attributes->class($classes) }} data-laraliveui-checkbox-indicator>
    <laraliveui:icon.check variant="micro" class="hidden text-[var(--color-accent-foreground)]" />
    <laraliveui:icon.minus variant="micro" class="hidden text-[var(--color-accent-foreground)]" />
</div>
