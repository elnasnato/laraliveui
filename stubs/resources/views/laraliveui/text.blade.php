...
<?php if ($inline) : ?><span {{ $attributes->class($classes) }} data-laraliveui-text @if ($color) color="{{ $color }}" @endif>{{ $slot }}</span><?php else: ?><p {{ $attributes->class($classes) }} data-laraliveui-text @if ($color) data-color="{{ $color }}" @endif>{{ $slot }}</p><?php endif; ?>